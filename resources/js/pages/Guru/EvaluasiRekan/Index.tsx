...
import { Calendar, CheckCircle, CircleAlert, Filter, Search, UserCheck, Users } from 'lucide-react';
...
interface EvaluasiRekanIndexProps extends PageProps {
...
export default function EvaluasiRekanIndex({
    periodeAktif,
    guruList = [],
    completedEvaluasi = [],
    mataPelajaran = [],
    ...
    // Debug log for mata pelajaran per guru
    // useEffect(() => {
    //     console.log('Debug Guru List with Mata Pelajaran:');
    //     guruList.forEach((guru) => {
    //         console.log(`Guru: ${guru.user.name} (${guru.nip})`, {
    //             id: guru.id,
    //             mataPelajaran: guru.mata_pelajaran || 'Tidak memiliki mata pelajaran',
    //             isEvaluated: completedEvaluasi.includes(guru.id),
    //         });
    //     });
    // }, [guruList, completedEvaluasi]);
    ...
    const goToCreateForm = (guruId: number) => {
        router.get(route('evaluasi-rekan.create', guruId));
    };
    ...
    const goToViewForm = (guruId: number) => {
        ...
        router.get(route('evaluasi-rekan.show', evaluasiId));
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Evaluasi Rekan Guru" />
            ...
            <div className="space-y-6 p-4">
                ...
                <div className="mb-6 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-6">
                    <div className="mx-auto max-w-5xl">
                        <h1 className="text-2xl font-bold text-indigo-800">Form Evaluasi Rekan Guru</h1>
                        <p className="mt-2 text-indigo-600">Lakukan evaluasi terhadap kinerja rekan guru Anda untuk pengembangan profesional</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Cari Rekan Guru</CardTitle>
                        <CardDescription>Cari rekan guru untuk dievaluasi berdasarkan nama atau NIP</CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <CardContent className="pb-2">
                                        {/* Debug info - Bisa dihapus setelah perbaikan selesai */}
                                        ...
                                        <div className="mt-1 flex flex-wrap gap-1">
                                            {guru.mata_pelajaran ? (
                                                ...
                                                Array.isArray(guru.mata_pelajaran) && guru.mata_pelajaran.length > 0 ? (
                                                    ...
                                                    // Handle mata_pelajaran sebagai objek tunggal
