...
export default function Show({ 
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: route('evaluasi-rekan.show', evaluasi.id),
        },
    ];

    const handleEdit = () => {
        router.get(route('evaluasi-rekan.edit', evaluasi.id));
    };
    ...
    const handleExport = () => {
        window.open(route('evaluasi-rekan.export', evaluasi.id), '_blank');
    };
            ...
            <div className="p-4 space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-2xl font-bold">Detail Evaluasi Rekan</h1>
                    </div>
